...
public class Cannonball : MonoBehaviour
{
    ...
    [SerializeField] private bool createPlaceholderEffectWhenPrefabMissing = true;
    ...
    {
        ConfigureExplosion(enabled, radius, damageAmount, explosionEffectPrefab, explosionDamageMask);
    }
    ...
    private void SpawnExplosionEffect()
    {
        ...
        else if (createPlaceholderEffectWhenPrefabMissing)
        {
    ...
    private GameObject CreatePlaceholderExplosionEffect()
    {
        ...
        effect.transform.localScale = Vector3.one * Mathf.Max(0.1f, explosionRadius * 2f);

        SpriteRenderer spriteRenderer = effect.AddComponent<SpriteRenderer>();
        spriteRenderer.sprite = GetPlaceholderExplosionSprite();
        spriteRenderer.color = new Color(1f, 0.55f, 0.05f, 0.65f);
